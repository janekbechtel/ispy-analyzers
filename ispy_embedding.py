...
process.source = cms.Source(
    ...
    fileNames=cms.untracked.vstring(
        'file:/portal/ekpbms1/home/sbrommer/embedding_2018/v4/CMSSW_10_2_4_patch1/src/briefing/MuTau_data_2018ABC_CMSSW1020/reco_selected.root'
    ))
...
process.add_(
    cms.Service(
        "ISpyService",
        outputFileName=cms.untracked.string('ispy_selected.ig'),
        outputIg=cms.untracked.bool(True),
        outputMaxEvents=cms.untracked.int32(
            45),  # These are the number of events per ig file 
...
process.ISpyCSCStripDigi.iSpyCSCStripDigiTag = cms.InputTag(
    'muonCSCDigis:MuonCSCStripDigi')
process.ISpyCSCStripDigi.thresholdOffset = cms.int32(9)
process.ISpyCSCWireDigi.iSpyCSCWireDigiTag = cms.InputTag(
...
process.ISpyESRecHit.iSpyESRecHitTag = cms.InputTag(
...
process.ISpyJet.iSpyJetTag = cms.InputTag("ak4PFJetsCHS")
process.ISpyL1GlobalTriggerReadoutRecord.iSpyL1GlobalTriggerReadoutRecordTag = cms.InputTag(
    "gtDigis")
...
process.ISpyPreshowerCluster.iSpyPreshowerClusterTags = cms.VInputTag(
...
process.ISpySiPixelCluster.iSpySiPixelClusterTag = cms.InputTag(
    "siPixelClusters")
process.ISpySiPixelRecHit.iSpySiPixelRecHitTag = cms.InputTag("siPixelRecHits")
process.ISpySiStripCluster.iSpySiStripClusterTag = cms.InputTag(
    "siStripClusters")
process.ISpySiStripDigi.iSpySiStripDigiTag = cms.InputTag(
    "siStripDigis:ZeroSuppressed")
process.ISpySuperCluster.iSpySuperClusterTag = cms.InputTag(
    'hybridSuperClusters')
...
process.iSpy = cms.Path(
    process.ISpyEvent * process.ISpyCSCRecHit2D * process.ISpyCSCSegment *
    process.ISpyCSCStripDigi * process.ISpyCSCWireDigi * process.ISpyDTDigi *
    process.ISpyDTRecHit * process.ISpyDTRecSegment4D * process.ISpyEBRecHit *
    process.ISpyEERecHit * process.ISpyESRecHit * process.ISpyGsfElectron *
    process.ISpyHBRecHit * process.ISpyHERecHit * process.ISpyHFRecHit *
    process.ISpyHORecHit * process.ISpyJet *
    process.ISpyL1GlobalTriggerReadoutRecord * process.ISpyMET *
    process.ISpyMuon * process.ISpyPhoton * process.ISpyPixelDigi *
    process.ISpyPreshowerCluster * process.ISpyRPCRecHit *
    process.ISpySiPixelCluster * process.ISpySiPixelRecHit *
    #process.ISpySiStripCluster*
    #process.ISpySiStripDigi*
    process.ISpySuperCluster * process.ISpyTrack * process.ISpyTrackingRecHit *
